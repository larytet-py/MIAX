...
ESesM.fields.f_order_instructions = ProtoField.string("ESesM.order_instructions", "", base.ASCII)
...
ESesM.fields.f_self_trade_protection = ProtoField.string("ESesM.self_trade_protection", "", base.ASCII)
